/**
 * Static location dataset used as a client-side fallback when Elasticsearch
 * is not reachable. Mirrors the seed data in the backend.
 */
export const STATIC_LOCATIONS = [
  ...
  { id: "AMD", name: "Ahmedabad",          code: "AMD", type: "city",    country: "India",        state: "Gujarat",                  description: "Sardar Vallabhbhai Patel International Airport",    aliases: "Amdavad" },
  ...
  { id: "IXJ", name: "Jammu",              code: "IXJ", type: "city",    country: "India",        state: "Jammu and Kashmir",        description: "Jammu Airport",                                     aliases: "" },
  ...
  { id: "IN-AP", name: "Andhra Pradesh",           code: "AP", type: "state", country: "India", state: "Andhra Pradesh",           description: "State — Visakhapatnam, Vijayawada, Tirupati",      aliases: "AP Andhra" },
  ...
  { id: "MAD", name: "Madrid",          code: "MAD", type: "city", country: "Spain",                state: "",                description: "Adolfo Suárez Madrid–Barajas Airport",         aliases: "Spain" },
  ...
  { id: "CGK", name: "Jakarta",         code: "CGK", type: "city", country: "Indonesia",            state: "DKI Jakarta",     description: "Soekarno-Hatta International Airport",        aliases: "Indonesia Bali" },
  ...
  { id: "COUNTRY-TH", name: "Thailand",             code: "TH",  type: "country", country: "Thailand",             state: "", description: "Bangkok, Phuket, Chiang Mai",                   aliases: "" },
  { id: "COUNTRY-AU", name: "Australia",            code: "AU",  type: "country", country: "Australia",            state: "", description: "Sydney, Melbourne, Brisbane",                    aliases: "OZ Down Under" },
  { id: "COUNTRY-JP", name: "Japan",                code: "JP",  type: "country", country: "Japan",                state: "", description: "Tokyo, Osaka, Kyoto",                           aliases: "Nihon Nippon" },
  { id: "COUNTRY-CA", name: "Canada",               code: "CA",  type: "country", country: "Canada",               state: "", description: "Toronto, Vancouver, Montreal",                  aliases: "" },
  { id: "COUNTRY-MY", name: "Malaysia",             code: "MY",  type: "country", country: "Malaysia",             state: "", description: "Kuala Lumpur, Penang, Langkawi",                aliases: "" },
  { id: "COUNTRY-DE", name: "Germany",              code: "DE",  type: "country", country: "Germany",              state: "", description: "Berlin, Frankfurt, Munich",                      aliases: "Deutschland" },
  { id: "COUNTRY-FR", name: "France",               code: "FR",  type: "country", country: "France",               state: "", description: "Paris, Lyon, Marseille",                        aliases: "" },
  { id: "COUNTRY-IT", name: "Italy",                code: "IT",  type: "country", country: "Italy",                state: "", description: "Rome, Milan, Venice, Florence",                 aliases: "Italia" },
  { id: "COUNTRY-NZ", name: "New Zealand",          code: "NZ",  type: "country", country: "New Zealand",          state: "", description: "Auckland, Wellington, Queenstown",              aliases: "NZ Kiwi" },
  { id: "COUNTRY-ZA", name: "South Africa",         code: "ZA",  type: "country", country: "South Africa",         state: "", description: "Cape Town, Johannesburg",                       aliases: "" },
  { id: "COUNTRY-LK", name: "Sri Lanka",            code: "LK",  type: "country", country: "Sri Lanka",            state: "", description: "Colombo, Kandy, Galle",                         aliases: "Lanka Ceylon" },
  { id: "COUNTRY-NP", name: "Nepal",                code: "NP",  type: "country", country: "Nepal",                state: "", description: "Kathmandu, Pokhara, Chitwan",                   aliases: "Himalaya" },
  { id: "COUNTRY-PH", name: "Philippines",          code: "PH",  type: "country", country: "Philippines",          state: "", description: "Manila, Cebu, Davao",                           aliases: "" },
  { id: "COUNTRY-ID", name: "Indonesia",            code: "ID",  type: "country", country: "Indonesia",            state: "", description: "Bali, Jakarta, Yogyakarta",                      aliases: "Bali" },
];

/**
 * Filter static locations by query string.
 * Searches name, code, state, country, description and aliases fields.
 */
export function filterStaticLocations(query, { type, size = 8 } = {}) {
  const q = query.toLowerCase().trim();
  if (!q) return [];

  const scored = STATIC_LOCATIONS
    .filter((loc) => !type || loc.type === type)
    .map((loc) => {
      const fields = [
        loc.name,
        loc.code,
      ...
      if (loc.code.toLowerCase() === q) score += 100;
      // Name starts with query
      if (fields[0].startsWith(q)) score += 80;
      // Name contains query
      else if (fields[0].includes(q)) score += 60;
      // Code contains query
      if (fields[1].includes(q)) score += 50;
      // Alias match
      if (fields[2].includes(q)) score += 40;
      // State match
      if (fields[3].includes(q)) score += 30;
      // Country match
      if (fields[4].includes(q)) score += 20;
      // Description match
      if (fields[5].includes(q)) score += 10;
